...
namespace AvalonDock.Controls
{
    ...
    public class OverlayWindow : Window, IOverlayWindow
    {
        ...
        // Showing and activating 4 outer drop taget buttons over DockingManager
        // Showing and activating 5 inner drop target buttons over layout anchorable pane
        private Grid _gridDocumentPaneDropTargets;

        // Showing and activating 5 inner drop target buttons over document pane
        ...
        public bool IsHostedInFloatingWindow
            => _host is LayoutDocumentFloatingWindowControl || _host is LayoutAnchorableFloatingWindowControl;
